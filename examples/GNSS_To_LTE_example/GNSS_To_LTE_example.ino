...
void loop() {
	...
	if(r == ME310::RETURN_VALID)
	{
		...
		if(r == ME310::RETURN_VALID)
		{
			...
			Serial.print("SEND: ");
			r = myME310.socket_send_data_command_mode_extended(connID, (int) strlen(GNSS_buf)+1, GNSS_buf, 1, ME310::TOUT_30SEC);  //include the NULL character
			Serial.println(myME310.return_string(r));
			if(r != ME310::RETURN_VALID)
			{
			...
			else
			{
				...
				{
					Serial.print("READ: ");
					r = myME310.socket_receive_data_command_mode(connID, (int) strlen(GNSS_buf)+1, 0, ME310::TOUT_10SEC);  //issue command AT#SRECV=connID,size and wait for answer or timeout
					Serial.println(myME310.return_string(r));
					if(r == ME310::RETURN_VALID)
					{
