...
void setup() {
  ...
  xTaskCreate(vMQTTTask, "MQTT_Task", 8192, NULL, 2, &xMQTTTaskHandle);
  xTaskCreate(vSensorTask, "Sensor_Task", 2048, NULL, 1, NULL);  
  xTaskCreate(vCommandTask, "Cmd_Task", 2048, NULL, 1, &xCommandTaskHandle);
}
